...
- [ ] Build editor UI
- [ ] Theoretical boon/condition uptime calculator (per-skill/trait rules, ICDs, stacking
      duration vs. intensity, boon duration/concentration scaling) — start with 2-3 meta WvW
      support builds (e.g. firebrand, herald) before covering all professions
