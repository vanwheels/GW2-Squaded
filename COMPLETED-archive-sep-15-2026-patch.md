# Completed (archive through "Sep 15, 2026 patch + fixes" milestone)

Everything from the v1.0.0 release (2026-08-15) through the "Sep 15, 2026 patch + fixes" milestone
(shipped 2026-09-16). Continues in `COMPLETED.md`. Entries are most recent first. Everything before
v1.0.0 is archived in `COMPLETED-archive-pre-1.0.md`.
...
row below the label rather than fighting it for the same line. See commit `93177db`.
